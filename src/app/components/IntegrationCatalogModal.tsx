...
const CATALOG_CATEGORIES = [
  ...
  },
  {
    ...
    connectors: [
      ...
      { type: 'twilio' as ConnectorType,       description: 'Twilio IVR — programmable voice & call tracking',            popular: true, badge: 'Vendor' },
      ...
      { type: 'cloudtalk' as ConnectorType,    description: 'CloudTalk call center and IVR integration',                               badge: 'Vendor' },
      { type: 'ringcentral' as ConnectorType,  description: 'RingCentral cloud communications platform',                               badge: 'Vendor' },

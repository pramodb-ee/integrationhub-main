...
const CATEGORY_GROUPS: { label: string; connectors: ConnectorEntry[] }[] = [
  ...
  },
  {
    ...
    connectors: [
      ...
      { type: 'twilio',       description: 'Twilio IVR — programmable voice & call tracking',          category: 'Telephony / IVR', badge: 'Vendor' },
      ...
      { type: 'cloudtalk',    description: 'CloudTalk call center and IVR integration',                category: 'Telephony / IVR', badge: 'Vendor' },
      { type: 'ringcentral',  description: 'RingCentral cloud communications platform',                category: 'Telephony / IVR', badge: 'Vendor' },

...
export type ConnectorType =
  ...
  | 'api'| 'js' | 'php' | 'id-based' |'ivr'| 'tata' | 'exotel' | 'knowlarity' | 'twilio' | 'ozonetel' | 'myoperator' | 'cloudtalk' | 'ringcentral' | 'ivr-custom' |'erp-crm'
  | 'zapier';
...
const connectorConfig: Record<ConnectorType, { label: string; bg: string; text: string; abbr: string }> = {
  ...
  'id-based':      { label: 'ID Based',         bg: '#059669', text: '#FFFFFF', abbr: 'ID'  },
